<%-- 
    Document   : addItem
    Created on : Jan 2, 2024, 8:42:07 PM
    Author     : lap
--%>
...
<html>
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="product">
                <h1>Add Product</h1>
                <form class="product__form" action="addItem" method="post">
                    <div class="form__info">
                        <div class="form__input">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="sellPrice" name="sellPrice" required />
                            </div>
                            <!-- <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="categoryID" id="categoryID">
                                    <c:forEach var="it" items="${requestScope.listCate}">
                        ...
                        <div class="form__image">
                            ...
                            <img id="preview" src="assets/image/bedroom.jpg">
