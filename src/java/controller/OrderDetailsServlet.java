...
public class OrderDetailsServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(id == null){
            ...
            ArrayList<OrderItem> listOrderItem = oidb.getListItemByOrder(order);
            String newDate = formatDateDB(order.getOrderDate());
            order.setOrderDate(newDate);
            request.setAttribute("order", order);
            request.setAttribute("listOrderIt", listOrderItem);
