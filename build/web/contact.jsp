<%-- 
    Document   : contact
    Created on : Nov 20, 2023, 10:05:15 PM
    Author     : lap
--%>
            ...
            <div class="container">
                <div class="contact__main">
                    <div class="contact__header">
                        ...
                        <span>For More Information About Our Product & Services. Please Feel Free
                        ...
                        <div class="contact__left">
                            <div class="contact__item">
                                ...
                                <div class="contact__item-content">
                                    <h2>Address</h2>
                                    <p>Km10, Nguyen Trai Street, Ha Dong District, Hanoi</p>
                                </div>
                            </div>
                            <div class="contact__item">
                                <div class="contact__item-icon">
                        ...
                        <div class="contact__right">
                            <form class="contact__form">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" required placeholder="ABC">
                                </div>
                                <div class="form-group">
